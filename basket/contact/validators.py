...
def count_urls(value: str, field_name: str) -> str:
    count = len(URL_PATTERN.findall(value))
    if count > 2:
        raise ValueError(f"{field_name} must not contain multiple URLs or domain names")
    return value
