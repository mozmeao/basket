...
class BrazeTxEmailMessageAdmin(admin.ModelAdmin):
    fields = ("message_id", "campaign_id", "language", "description", "private")
    list_display = ("message_id", "campaign_id", "language", "description", "private")
    search_fields = ("message_id", "campaign_id", "description")
